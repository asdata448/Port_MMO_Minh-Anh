...
export default function Contact() {
  ...
  return (
    <section id="contact" className="py-20 bg-gradient-to-br from-rose-50/50 to-pink-50/50">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-12">
            {contactMethods.map((method, index) => (
              <motion.a
                ...
                className={`bg-white rounded-2xl p-6 shadow-xl text-center card-hover ${
                  method.link ? 'cursor-pointer' : 'cursor-default'
                }`}
              >
                <div className={`w-16 h-16 mx-auto mb-4 rounded-full bg-gradient-to-r ${method.gradient} flex items-center justify-center text-3xl`}>
                  {method.icon}
                </div>
          ...
          >
            ...
            <form className="space-y-4">
              ...
              <button
                type="submit"
                className="w-full py-4 bg-gradient-to-r from-pink-400 to-rose-400 text-white rounded-xl font-semibold hover:shadow-lg hover:scale-[1.02] transition-all duration-300"
              >
                Gửi tin nhắn
              </button>
            </form>
